...
const CreatePlayer = () => {
    ...
    return ((0, jsx_runtime_1.jsxs)(react_2.Flex, { id: "CreatePlayer", alignItems: "center", justifyContent: "center", height: "100vh", minW: 870, flexDirection: "column", padding: 30, onKeyDown: (e) => {
            if (e.key === "Enter") {
                createPlayerHandler();
            }
        }, children: [(0, jsx_runtime_1.jsx)(react_2.Heading, { as: "h1", mb: 50, size: "2xl", children: "create player" }, void 0), (0, jsx_runtime_1.jsxs)(react_2.Flex, { flexDirection: "row", justifyContent: "space-between", w: "80vw", ml: "10vw", mr: "10vw", mb: "10vh", p: "20", gap: 50, flex: "100%", children: [(0, jsx_runtime_1.jsx)(react_2.Flex, { flexDirection: "column", flexGrow: "1;0", 
                        //   p={15}
                        alignItems: "center", justifyContent: "center", children: (0, jsx_runtime_1.jsxs)(react_2.Flex, { alignItems: "flex-start", flexDirection: "column", children: [(0, jsx_runtime_1.jsx)(react_2.FormLabel, { fontWeight: "bold", fontSize: "3xl", htmlFor: "avatarSelector", children: "avatar" }, void 0), (0, jsx_runtime_1.jsx)(react_2.Box, { id: "avatarSelector", w: "15vw", minW: "220px", minH: "220px", h: "15vw", borderWidth: 3, borderColor: "blackAlpha.200", cursor: "pointer", children: (0, jsx_runtime_1.jsx)(react_2.Center, { w: "100%", h: "100%", children: (0, jsx_runtime_1.jsx)(react_2.Text, { children: "*coming soon*" }, void 0) }, void 0) }, void 0)] }, void 0) }, void 0), (0, jsx_runtime_1.jsxs)(react_2.Flex, { flexDirection: "column", flexGrow: 1.5, w: "", justifyContent: "center", children: [(0, jsx_runtime_1.jsx)(react_2.FormLabel, { htmlFor: "usernameInput", fontWeight: "bold", fontSize: "3xl", children: "username" }, void 0), (0, jsx_runtime_1.jsx)(react_2.Input, { id: "usernameInput", placeholder: "input ur username", variant: "filled", mb: 3, borderWidth: 3, focusBorderColor: "blackAlpha.500", size: "lg", w: "50%", onChange: (e) => {
                                    usernameHandler(e);
